...
- Name: specs\changePassword.spec.js >> OTS EdTech Change Password >> TC_CHGPWD_001: Change Password page loads with heading and email field visible
- Location: tests\specs\changePassword.spec.js:32:3
