...
- Name: specs\favoriteChapters.spec.js >> OTS EdTech Favorite Chapters Page >> TC_FAVCHAP_002: Page heading and header container are present
- Location: tests\specs\favoriteChapters.spec.js:57:3
    ...
    - main [ref=e9]:
      - generic [ref=e10]:
        ...
        - generic [ref=e69] [cursor=pointer]:
          - generic [ref=e70]:
            - paragraph [ref=e71]: 🐌 Slow and steady wins the race
            - paragraph [ref=e72]: Hover to speed up!
          - generic:
            - generic:
              - paragraph: ✨
            - generic:
