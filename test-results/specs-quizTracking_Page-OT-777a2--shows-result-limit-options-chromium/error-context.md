...
- Name: specs\quizTracking_Page.spec.js >> OTS EdTech Quiz Performance Tracking >> TC_QUIZTRACKING_015: Show Results dropdown shows result limit options
- Location: tests\specs\quizTracking_Page.spec.js:374:3
...
Locator:  getByRole('option', { name: 'All Results' })
Expected: visible
Received: hidden
Timeout:  15000ms
...
Call log:
  ...
  - waiting for getByRole('option', { name: 'All Results' })
    32 × locator resolved to <option value="all">All Results</option>
