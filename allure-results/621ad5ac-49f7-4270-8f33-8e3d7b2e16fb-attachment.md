...
- Name: specs\homePage.spec.js >> OTS EdTech Homepage >> TC_HOME_021: Section Start Learning link navigates correctly
- Location: tests\specs\homePage.spec.js:520:3
...
Call log:
  - waiting for getByRole('link', { name: 'Start Learning', exact: true })
    - locator resolved to <a rel="noopener" target="_blank" href="https://www.instagram.com/otsedtech/" class="chakra-link chakra-button css-oawvot">…</a>
...
- generic [ref=e1]:
  ...
  - dialog [ref=e1181]:
    - generic [ref=e1183]:
      - button "Close" [active] [ref=e1188] [cursor=pointer]:
        - img [ref=e1189]
      - img "Off The School App" [ref=e1197]
      - generic [ref=e1199]:
        - generic [ref=e1201]:
          - img [ref=e1202]
          - paragraph [ref=e1204]: Off The School App
        - heading "Start Learning Smarter Anytime, Anywhere" [level=2] [ref=e1206]:
          - text: Start Learning Smarter
          - text: Anytime, Anywhere
        - paragraph [ref=e1208]: Download our app and unlock courses, quizzes, and a personalized learning experience.
        - generic [ref=e1209]:
          - generic [ref=e1211]:
            - img [ref=e1212]
            - paragraph [ref=e1214]: 100+ Courses
          - generic [ref=e1216]:
            - img [ref=e1217]
            - paragraph [ref=e1219]: Free Download
        - generic [ref=e1221]:
          - img [ref=e1222]
          - img [ref=e1224]
          - img [ref=e1226]
          - img [ref=e1228]
          - img [ref=e1230]
          - paragraph [ref=e1232]: 4.8 Rating
        - link "Google Play Get it on Google Play" [ref=e1234] [cursor=pointer]:
          - /url: https://play.google.com/store/apps/details?id=com.otsapp
          - generic [ref=e1236]:
            - img "Google Play" [ref=e1237]
            - generic [ref=e1238]:
              - paragraph [ref=e1239]: Get it on
              - paragraph [ref=e1240]: Google Play
```
