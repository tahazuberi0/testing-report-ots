...
- Name: specs\homePage.spec.js >> OTS EdTech Homepage >> TC_HOME_002: Start Learning — It's Free navigates to registration or catalog
- Location: tests\specs\homePage.spec.js:61:3
...
Call log:
  - waiting for getByRole('link', { name: 'Start Learning — It\'s Free' })
    - locator resolved to <a href="/explore" data-discover="true" class="chakra-button css-1c7acz8">…</a>
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <img alt="Off The School App" class="chakra-image css-oyqelm" src="/assets/playstorepopup.webp"/> from <div class="chakra-portal">…</div> subtree intercepts pointer events
  - retrying click action
    - waiting 100ms
    - waiting for element to be visible, enabled and stable
    - element is visible, enabled and stable
